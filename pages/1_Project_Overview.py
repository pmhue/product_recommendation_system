...
Xây dựng Recommendation System cho một hoặc một số nhóm hàng hóa trên hasaki.vn giúp đề xuất và gợi ý cho người dùng/ khách hàng. 
...
- Sử dụng thư viện Surprise để xây dựng mô hình SVD++.
